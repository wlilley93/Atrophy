...
memory. Switch with a          Gmail and Calendar. Agents
...
Google — calendar & email   Free (OAuth). Your agent can read your
                            calendar and email, create events,
