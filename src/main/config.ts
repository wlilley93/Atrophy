...
export class Config {
  ...
  private _resolveAgent(name: string): void {
    ...
    this.WINDOW_WIDTH = (disp.window_width as number) ?? cfg('WINDOW_WIDTH', 1100);
    this.WINDOW_HEIGHT = (disp.window_height as number) ?? cfg('WINDOW_HEIGHT', 1466);
